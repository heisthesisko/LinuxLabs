...
# BITS job details
$bitsJobs = @(
    @{ JobName = "Job1"; SourceUrl = "https://mirrors.ocf.berkeley.edu/ubuntu-releases/24.04/ubuntu-24.04-live-server-amd64.iso"; DestinationPath = "C:\\LinuxLab\\Ubuntu-24.iso" },
    ...
    @{ JobName = "Job3"; SourceUrl = "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.6.0-amd64-netinst.iso"; DestinationPath = "C:\\LinuxLab\\Debian-12.iso" },
